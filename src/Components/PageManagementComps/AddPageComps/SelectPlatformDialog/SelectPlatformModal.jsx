...
export default function PagesDialog(props) {
  ...
  React.useEffect(() => {
    ...
    let url2 =
      process.env.REACT_APP_BACKENDURL + process.env.REACT_APP_GETAPPPLATFORMS;
  ...
  return (
    <>
      ...
      >
        <DialogTitle id="alert-dialog-title">Platform Select</DialogTitle>
        <DialogContent>
          <DialogContentText className="m-2" id="alert-dialog-description">
            Welcome Please Select the platform you want to load your pages from
          </DialogContentText>
          <div
            sx={{
              display: 'flex',
