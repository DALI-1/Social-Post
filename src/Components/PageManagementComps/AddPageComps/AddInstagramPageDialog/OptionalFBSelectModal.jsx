      ...
      >
        ...
        <DialogContent>
          <DialogContentText className="m-2" id="alert-dialog-description">
            The Selected Instagram businesss accounts are linked to these
            Facebook pages, would you like to add them as well and have them
          ...
          {pages.map((Page, index) => {
            return (
              <Form.Check
                id={'INGFBOptionalPage' + Page.id}
                key={'INGFBOptionalPage' + Page.id}
                type="switch"
